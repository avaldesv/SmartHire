...
EN_BY_ID = {
    **EN_BY_ID,
    ...
    "preselection.bulk.contactSent": "sent",
    "preselection.bulk.contactFailed": "failed",
    "candidateApplication.stage.applied": "Applied",
    "candidateApplication.stage.preselected": "Preselected",
    "candidateApplication.stage.preselection": "Preselection",
    "candidateApplication.stage.selected": "Selected",
    "candidateApplication.stage.prehired": "Pre-hired",
    "candidateApplication.stage.interview": "Interview",
    "candidateApplication.stage.evaluation": "Evaluation",
    "candidateApplication.stage.documents": "Documents",
    "candidateApplication.stage.hired": "Hired",
    "candidateApplication.stage.released": "Released",
    "validateInfoDialog.title": "Validate information",
    "validateInfoDialog.forPosition": "position",
    "validateInfoDialog.loading": "Loading form…",
    "validateInfoDialog.loadError": "Could not load the form.",
    "validateInfoDialog.saveError": "Could not save and validate the information.",
    "validateInfoDialog.back": "Back",
    "validateInfoDialog.next": "Continue",
    "validateInfoDialog.save": "Save and validate",
    "validateInfoDialog.saving": "Saving…",
    "validateInfoDialog.tab.personal": "Personal data",
    "validateInfoDialog.tab.beneficiaries": "Beneficiaries",
    "validateInfoDialog.tab.emergency": "Emergency contacts",
    "validateInfoDialog.section.general": "General information",
    "validateInfoDialog.section.gov": "Government institutions information",
    "validateInfoDialog.section.tax": "Tax information",
    "validateInfoDialog.section.birth": "Birth information",
    "validateInfoDialog.section.residence": "Residence information",
    "validateInfoDialog.section.studies": "Education information",
    "validateInfoDialog.section.beneficiary": "Beneficiary",
    "validateInfoDialog.section.beneficiariesList": "Beneficiaries",
    "validateInfoDialog.section.contacts": "Contacts",
    "validateInfoDialog.section.contactsList": "Added contacts",
    "validateInfoDialog.hint.beneficiaries": "The beneficiary will appear in the employment contract. Life insurance: Primary (1–5 beneficiaries), Contingent (1–3). The percentage sum per type must be 100%.",
    "validateInfoDialog.hint.emergency": "Two emergency contacts are required.",
    "validateInfoDialog.error.personalRequired": "First name, last names and email are required.",
    "validateInfoDialog.error.emptyBeneficiaries": "Add at least one beneficiary.",
    "validateInfoDialog.error.beneficiaryDraft": "Complete type, name, last names, relationship and percentage for the beneficiary.",
    "validateInfoDialog.error.beneficiaryRow": "Complete first name, last name and percentage for each beneficiary.",
    "validateInfoDialog.error.percentSum": "The percentage sum per type (PRIMARY / CONTINGENT) must be 100%.",
...
EN_BY_SOURCE: dict[str, str] = {
    ...
    "Tabs del formulario Completar información": "Complete information form tabs",
    "Define qué secciones se pedirán al candidato": "Define which sections will be requested from the candidate",
    "Datos personales (siempre requerido)": "Personal data (always required)",
    ...
    # VIA Bot perfil gestión
    "Asistente VIA": "VIA Assistant",
    "Ámbito de búsqueda": "Search scope",
    "Pool de candidatos": "Candidate pool",
    "Postulados a la requisición": "Applicants to the requisition",
    "Indícame qué perfil buscas para esta vacante.": "Tell me what profile you need for this vacancy.",
    "Escribe una instrucción para el agente…": "Write an instruction for the agent…",
    "Nueva conversación": "New conversation",
    "Candidatos idóneos": "Matching candidates",
    "Actualizado tras el último mensaje": "Updated after the last message",
    "resultados": "results",
    "Agregar a preselección": "Add to preselection",
    "Aún no hay candidatos. Envía una instrucción al asistente.": "No candidates yet. Send an instruction to the assistant.",
    "No se pudo cargar la conversación": "Could not load the conversation",
    "No se pudo enviar el mensaje al asistente": "Could not send the message to the assistant",
    "No se pudo reiniciar la conversación": "Could not reset the conversation",
    "Conversación reiniciada": "Conversation reset",
    "No se pudo agregar a preselección": "Could not add to preselection",
    "candidato(s) agregado(s) a preselección": "candidate(s) added to preselection",
    "Selecciona al menos un candidato": "Select at least one candidate",
    ...
    "Credenciales de portales": "Portal credentials",
    "Configura usuario y contraseña por cada portal de publicación activo.": "Set username and password for each active job portal.",
    "Usuario": "Username",
    "Contraseña": "Password",
    "Configurado": "Configured",
    "Sin configurar": "Not configured",
    "Credenciales de portales guardadas": "Portal credentials saved",
    "No se pudo cargar las credenciales de portales": "Could not load portal credentials",
    ...
    "Ej. OCC-AB12X9": "E.g. OCC-AB12X9",
    "Portales asociados": "Associated portals",
    "Identificador externo": "External ID",
    "Seleccionar portal…": "Select portal…",
    "Este portal ya está asociado": "This portal is already associated",
    "Ingrese el identificador externo": "Enter the external identifier",
    "Portales publicados": "Published portals",
    ...
    "Cita": "Appointment",
    "Cita para entrevista": "Interview appointment",
    "Selección de candidatos": "Candidate selection",
    "Perfil gestión (AI)": "Management profile (AI)",
    "Preselección": "Preselection",
    "Análisis": "Analysis",
    "Agregar del pool": "Add from pool",
    "Ver postulados": "View applicants",
    "Enviar Smart": "Send Smart",
    "Solicitar documentos": "Request documents",
    "No hay candidatos preseleccionados en esta posición.": "There are no preselected candidates for this position.",
    "Acciones del candidato": "Candidate actions",
    "Candidato": "Candidate",
    "Compat.": "Match",
    "Etapa": "Stage",
    ...
    "Clic para marcar/desmarcar · Fecha automática al marcar": "Click to mark/unmark · Date set automatically when marked",
    "Entrevista realizada · Clic para desmarcar": "Interview completed · Click to unmark",
    "Entrevista registrada": "Interview recorded",
    "Marca de entrevista eliminada": "Interview mark removed",
    "No se pudo actualizar el estado de entrevista": "Could not update interview status",
    "Marcar como seleccionado": "Mark as selected",
    "Liberar": "Release",
    "Liberar todos": "Release all",
    "Contactar candidatos": "Contact candidates",
    "Enviar cita para entrevistas": "Send interview appointments",
    "Enviar citas para entrevistas": "Send interview appointments",
    "Se usará el horario sugerido del calendario para cada candidato.": "The suggested calendar slot will be used for each candidate.",
    "Citas de entrevista enviadas": "Interview appointments sent",
    "Algunas citas no se agendaron": "Some appointments were not scheduled",
    "Seleccione al menos un candidato en la tabla": "Select at least one candidate in the table",
    "¿Enviar cuestionario de contacto a los candidatos seleccionados?": "Send contact questionnaire to the selected candidates?",
    "Cuestionarios de contacto enviados": "Contact questionnaires sent",
    "Algunos cuestionarios no se enviaron": "Some questionnaires were not sent",
    "Candidatos seleccionados": "Candidates selected",
    "Selección liberada": "Selection released",
    "¿Liberar todas las postulaciones de esta posición? Se marcarán como RELEASED.": "Release all applications for this position? They will be marked as RELEASED.",
    "Todas las postulaciones liberadas": "All applications released",
    "No se pudo completar la acción masiva": "Could not complete the bulk action",
    "No se pudieron cargar los candidatos postulados": "Could not load applicant candidates",
    "candidato(s) postulado(s)": "candidate(s) applied",
    "candidato(s)": "candidate(s)",
    "pendiente de integración API": "pending API integration",
    "Deseleccionar": "Deselect",
    "Editar perfil": "Edit profile",
    "Descargar CV": "Download CV",
    "Modificar compatibilidad": "Edit match score",
    "Ver documentos": "View documents",
    "Validar información": "Validate information",
    "Validar estudios": "Validate studies",
    "Bitácora": "Audit log",
    "Enviar a SMART": "Send to SMART",
    "Generar contrato": "Generate contract",
    "Notificar cuestionario": "Notify questionnaire",
    "Candidato deseleccionado": "Candidate deselected",
    "Completo": "Complete",
    "Info ✓": "Info ✓",
    "Info pendiente": "Info pending",
    "Estudios ✓": "Studies ✓",
    "Estudios pendiente": "Studies pending",
    "Compatibilidad actualizada": "Match score updated",
    "No se pudo actualizar la compatibilidad": "Could not update match score",
    "Compatibilidad (%)": "Match score (%)",
    "No se pudo obtener la URL de descarga del CV": "Could not get the CV download URL",
    "La información ya está validada": "Information is already validated",
    "Información validada": "Information validated",
    "No se pudo validar la información": "Could not validate information",
    "Cargando formulario…": "Loading form…",
    "No se pudo cargar el formulario.": "Could not load the form.",
    "No se pudo guardar y validar la información.": "Could not save and validate the information.",
    "Regresar": "Back",
    "Continuar": "Continue",
    "Guardar y validar": "Save and validate",
    "Guardando…": "Saving…",
    "Datos Personales": "Personal data",
    "Beneficiarios": "Beneficiaries",
    "Contactos de Emergencia": "Emergency contacts",
    "Información general": "General information",
    "Información instituciones gobierno": "Government institutions information",
    "Información fiscal": "Tax information",
    "Información de nacimiento": "Birth information",
    "Información de residencia": "Residence information",
    "Información de estudios": "Education information",
    "Beneficiario": "Beneficiary",
    "Contactos": "Contacts",
    "Contactos agregados": "Added contacts",
    "Apellido paterno": "Paternal last name",
    "Apellido materno": "Maternal last name",
    "Puesto de interés": "Position of interest",
    "Experiencia": "Experience",
    "Sueldo de interés": "Desired salary",
    "Estado civil": "Marital status",
    "Régimen fiscal": "Tax regime",
    "Código postal RFC": "RFC postal code",
    "Entidad federativa": "State / province",
    "Código postal": "Postal code",
    "Municipio": "Municipality",
    "Colonia": "Neighborhood",
    "Calle": "Street",
    "No. exterior": "Exterior number",
    "No. interior": "Interior number",
    "Nivel de estudio": "Education level",
    ...
    "puesto": "position",
    "El beneficiario se reflejará en el contrato de trabajo. Seguro de vida: Primario (1–5 beneficiarios), Contingente (1–3). La suma de porcentajes por tipo debe ser 100%.": "The beneficiary will appear in the employment contract. Life insurance: Primary (1–5 beneficiaries), Contingent (1–3). The percentage sum per type must be 100%.",
    "Debe haber dos contactos obligatorios.": "Two emergency contacts are required.",
    "Nombre, apellidos y correo son obligatorios.": "First name, last names and email are required.",
    "Agrega al menos un beneficiario.": "Add at least one beneficiary.",
    "Completa tipo, nombre, apellidos, parentesco y porcentaje del beneficiario.": "Complete type, name, last names, relationship and percentage for the beneficiary.",
    "Completa nombre, apellido y porcentaje de cada beneficiario.": "Complete first name, last name and percentage for each beneficiary.",
    "La suma de porcentajes por tipo (PRIMARY / CONTINGENT) debe ser 100%.": "The percentage sum per type (PRIMARY / CONTINGENT) must be 100%.",
    "Debes registrar al menos 2 contactos de emergencia.": "You must register at least 2 emergency contacts.",
    "Completa nombre, apellido paterno y teléfono del contacto.": "Complete first name, paternal last name and phone for the contact.",
    "Completa nombre, apellido y teléfono de cada contacto de emergencia.": "Complete first name, last name and phone for each emergency contact.",
    "Los estudios ya están validados": "Studies are already validated",
    "Estudios validados": "Studies validated",
    "No se pudieron validar los estudios": "Could not validate studies",
    "No se pudo enviar a SMART": "Could not send to SMART",
    "No se pudo generar el contrato": "Could not generate the contract",
    "No se pudo enviar la invitación al cuestionario": "Could not send the questionnaire invitation",
    "Cambiar etapa": "Change stage",
    "Se actualizará la etapa de los candidatos seleccionados.": "The stage of the selected candidates will be updated.",
    "Nueva etapa": "New stage",
    "Aplicar": "Apply",
    "Etapa actualizada": "Stage updated",
    "No se pudo cambiar la etapa": "Could not change the stage",
    "No fue posible cargar el análisis para la posición": "Could not load analysis for the position",
    "No se pudieron cargar las métricas de análisis": "Could not load analysis metrics",
    "Postulaciones": "Applications",
    "Compatibilidad promedio": "Average match",
    "Preseleccionados": "Preselected",
    "Con entrevista": "With interview",
    "Contratados": "Hired",
    "Análisis detallado": "Detailed analysis",
    "Métricas calculadas desde el listado de postulaciones filtrado por posición.": "Metrics calculated from the applications list filtered by position.",
    "Datos en tiempo real del tenant (hasta 500 postulaciones para promedios).": "Real-time tenant data (up to 500 applications for averages).",
    "Postulado": "Applied",
    "Preseleccionado": "Preselected",
    "Seleccionado": "Selected",
    "Precontratado": "Pre-hired",
    "Contratado": "Hired",
    "Liberado": "Released",
    "Enviar cuestionario de contacto": "Send contact questionnaire",
    "Cuestionario de contacto enviado": "Contact questionnaire sent",
    "No se pudo enviar el cuestionario de contacto": "Could not send the contact questionnaire",
    "Completar información": "Complete information",
    "Solicitar documentos al candidato": "Request documents from the candidate",
    "No hay documentos requeridos": "No required documents",
    "Solicitud de documentos enviada": "Document request sent",
    "No se pudo solicitar documentos": "Could not request documents",
    "¿Solicitar documentos a los candidatos seleccionados?": "Request documents from the selected candidates?",
    "Solicitudes de documentos enviadas": "Document requests sent",
    "Algunas solicitudes de documentos no se enviaron": "Some document requests were not sent",
    "Solicitar completar información": "Request complete information",
    "Información ya validada": "Information already validated",
    "Solicitud de información enviada": "Information request sent",
    "No se pudo solicitar completar información": "Could not request complete information",
    "Evaluación del cuestionario": "Questionnaire evaluation",
    "Evaluación pendiente": "Evaluation pending",
    "Disponible cuando el candidato responda": "Available when the candidate responds",
    "Entrevista agendada — reprogramar": "Interview scheduled — reschedule",
    ...
    "Activas": "Active",
    "Preguntas promedio": "Avg. questions",
    "Vista previa": "Preview",
    "Seleccione una encuesta para ver sus preguntas": "Select a survey to preview its questions",
    "Esta encuesta no tiene preguntas": "This survey has no questions",
    "Estado": "Status",
    "Activa": "Active",
    "Inactiva": "Inactive",
    "Sesiones": "Sessions",
    "Por encuesta": "By survey",
    "Envíos": "Sent",
    ...
    "No hay envíos de encuestas": "No survey sends yet",
    "No se pudo cargar el resumen por encuesta": "Could not load survey summary",
    "Volver al resumen": "Back to summary",
    "Candidatos de la encuesta": "Survey candidates",
    "Editar": "Edit",
    "Mensaje inicial": "Initial message",
    "Mensaje final": "Final message",
    "Texto que recibe el candidato al iniciar la encuesta": "Text the candidate receives when the survey starts",
    "Texto que recibe el candidato al completar la encuesta": "Text the candidate receives when the survey is completed",
    "Mensajes WhatsApp": "WhatsApp messages",
    "Filtrar por candidato...": "Filter by candidate...",
    "Filtrar por encuesta...": "Filter by survey...",
    "Filtrar por posición...": "Filter by position...",
