      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            loadComponent: () =>
              import('./features/reports/recruiter-performance/recruiter-performance-report.component').then(
                (m) => m.RecruiterPerformanceReportComponent,
              ),
          },
          {
          ...
          {
            path: 'status-by-requisition',
            loadComponent: () =>
              import('./features/reports/status-by-requisition/status-by-requisition-report.component').then(
                (m) => m.StatusByRequisitionReportComponent,
              ),
          },
          {
            path: 'process-funnel',
