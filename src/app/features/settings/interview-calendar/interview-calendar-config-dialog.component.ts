...
export class InterviewCalendarConfigDialogComponent implements OnInit, OnDestroy {
  ...
  readonly labels = {
    ...
    buffer: INTERVIEW_CAL_BUFFER,
    expiration: INTERVIEW_CAL_EXPIRATION,
  ...
  readonly form = this.fb.nonNullable.group({
    ...
    confirmationExpirationHours: [48],
    externalCalendarUrl: [''],
    address: [''],
    instructions: [''],
    locationReferences: [''],
    ...
    this.api.getMyConfig().subscribe({
      next: (cfg) => {
        ...
        this.form.patchValue({
          ...
          confirmationExpirationHours: cfg.confirmationExpirationHours ?? 48,
    ...
    this.api
      .saveMyConfig({
        virtual: {
          ...
          minScheduleBufferHours: raw.virtualMinScheduleBufferHours,
        },
        presential: {
          ...
          availabilitySlots: [],
          minScheduleBufferHours: raw.presentialMinScheduleBufferHours,
        },
        reminder15Min: raw.reminder15Min,
        reminder1Hour: raw.reminder1Hour,
        excludeNonWorkingDays: raw.excludeNonWorkingDays,
        confirmationExpirationHours: raw.confirmationExpirationHours,
