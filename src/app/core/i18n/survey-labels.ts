...
export const SURVEYS_COL_DESCRIPTION = $localize`:@@surveys.col.description:Mensaje inicial`;
...
export const SURVEYS_FIELD_DESCRIPTION = $localize`:@@surveys.field.description:Mensaje inicial`;
export const SURVEYS_FIELD_DESCRIPTION_HINT = $localize`:@@surveys.field.descriptionHint:Texto que recibe el candidato al iniciar la encuesta`;
export const SURVEYS_FIELD_FINAL_MESSAGE = $localize`:@@surveys.field.finalMessage:Mensaje final`;
export const SURVEYS_FIELD_FINAL_MESSAGE_HINT = $localize`:@@surveys.field.finalMessageHint:Texto que recibe el candidato al completar la encuesta`;
export const SURVEYS_SECTION_MESSAGES = $localize`:@@surveys.section.messages:Mensajes WhatsApp`;
...
export const SURVEYS_RESULTS_FILTER_CANDIDATE = $localize`:@@surveys.results.filter.candidate:Filtrar por candidato...`;
export const SURVEYS_RESULTS_FILTER_SURVEY = $localize`:@@surveys.results.filter.survey:Filtrar por encuesta...`;
export const SURVEYS_RESULTS_FILTER_POSITION = $localize`:@@surveys.results.filter.position:Filtrar por posición...`;
export const SURVEYS_RESULTS_FILTER_DATE = $localize`:@@surveys.results.filter.date:Filtrar por fecha...`;
export const SURVEYS_RESULTS_FILTER_DATE_FROM = $localize`:@@surveys.results.filter.dateFrom:Desde`;
export const SURVEYS_RESULTS_FILTER_DATE_TO = $localize`:@@surveys.results.filter.dateTo:Hasta`;
