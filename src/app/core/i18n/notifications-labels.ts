...
export const NOTIFICATIONS_FILTER_ACTION = $localize`:@@notifications.filter.action:Acción`;
export const NOTIFICATIONS_FILTER_ACTIVE = $localize`:@@notifications.filter.active:Estado`;
export const NOTIFICATIONS_FILTER_ACTIVE_ALL = $localize`:@@notifications.filter.activeAll:Todos`;
export const NOTIFICATIONS_FILTER_ACTIVE_YES = $localize`:@@notifications.filter.activeYes:Activas`;
export const NOTIFICATIONS_FILTER_ACTIVE_NO = $localize`:@@notifications.filter.activeNo:Inactivas`;
export const NOTIFICATIONS_FILTER_SEARCH = $localize`:@@notifications.filter.search:Buscar`;
export const NOTIFICATIONS_FILTER_SEARCH_ACTION = $localize`:@@notifications.filter.searchAction:Código o descripción`;
export const NOTIFICATIONS_FILTER_CHANNEL = $localize`:@@notifications.filter.channel:Canal`;
export const NOTIFICATIONS_FILTER_MODULE = $localize`:@@notifications.filter.module:Módulo`;
export const NOTIFICATIONS_FILTER_COVERAGE = $localize`:@@notifications.filter.coverage:Cobertura`;
export const NOTIFICATIONS_FILTER_COVERAGE_ALL = $localize`:@@notifications.filter.coverageAll:Todas`;
export const NOTIFICATIONS_FILTER_COVERAGE_OK = $localize`:@@notifications.filter.coverageOk:Con plantilla`;
export const NOTIFICATIONS_FILTER_COVERAGE_MISSING = $localize`:@@notifications.filter.coverageMissing:Sin plantilla`;
export const NOTIFICATIONS_FILTER_APPLY = $localize`:@@notifications.filter.apply:Aplicar`;
export const NOTIFICATIONS_FILTER_CLEAR = $localize`:@@notifications.filter.clear:Limpiar`;
export const NOTIFICATIONS_CHANNEL_INBOX = $localize`:@@notifications.channel.inbox:Inbox`;
export const NOTIFICATIONS_CHANNEL_INBOX_VALUE = 'INBOX';
