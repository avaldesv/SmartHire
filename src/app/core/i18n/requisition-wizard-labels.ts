...
const REQUISITION_FIELD_LABELS: Record<string, string> = {
  ...
  documentIsRequired: $localize`:@@requisition.field.documentIsRequired:Obligatorio`,
...
export const REQUISITION_DOCS_WIZARD_VALIDITY_MONTHS = $localize`:@@requisition.documents.wizard.validityMonths:Meses`;
